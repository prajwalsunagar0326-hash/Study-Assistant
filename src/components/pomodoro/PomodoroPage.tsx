  ...
  return (
    <div className="w-full max-w-3xl mx-auto space-y-6 animate-fade-in pb-16">
      ...
      <div className="glass-panel p-6 sm:p-10 space-y-8 text-center relative overflow-hidden">
        ...
        {/* Mode Selector Tabs */}
        <div className="inline-flex p-1 rounded-xl bg-slate-950/60 border border-[var(--border)] max-w-sm mx-auto">
          <button
            type="button"
        ...
        {/* Celebration Banner */}
        {showCelebration && (
          <div className="p-3 rounded-xl bg-gradient-to-r from-emerald-500/20 via-indigo-500/20 to-emerald-500/20 border border-emerald-500/40 text-emerald-300 text-xs sm:text-sm font-bold flex items-center justify-center gap-2 animate-bounce">
        ...
        <div className="space-y-4">
          <div className="text-6xl sm:text-8xl font-black text-white tracking-tighter font-mono select-none drop-shadow-md">
            {formattedTime}
          </div>
        ...
        <div className="flex items-center justify-center gap-4 pt-2">
          <button
            ...
            onClick={handleReset}
            title="Reset Timer (R)"
            className="p-3 rounded-xl border border-[var(--border)] bg-slate-900/60 text-slate-300 hover:text-white hover:bg-slate-800 transition-all hover:scale-105"
          >
        ...
        <div className="text-[11px] text-[var(--muted-dark)]">
          Press <kbd className="px-1.5 py-0.5 rounded bg-slate-800 border border-slate-700 text-slate-300 font-mono">Space</kbd> to toggle • <kbd className="px-1.5 py-0.5 rounded bg-slate-800 border border-slate-700 text-slate-300 font-mono">R</kbd> to reset
        </div>
      </div>
